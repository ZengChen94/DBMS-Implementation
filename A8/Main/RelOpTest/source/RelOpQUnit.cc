...
//        RegularSelectionMultiThread myOp (supplierTableL, supplierTableOut, "== ([l_nationkey], int[1])", projections, THREAD_NUM);
		myOp.run ();
//		auto end = chrono::high_resolution_clock::now();
//		cout << "[RegularSelection Duration]: " << chrono::duration_cast<chrono::nanoseconds>(end-begin).count()  << " nanoseconds." << endl;
...
//		cout << "[Aggregate Duration]: " << chrono::duration_cast<chrono::nanoseconds>(end2-begin2).count()  << " nanoseconds." << endl;
...
//		RegularSelection myOp (supplierTableL, supplierTableOut, "&& (== ([l_nationkey], int[1]), > ([l_name], string [Supplier#000009378]))", projections);
        RegularSelectionMultiThread myOp (supplierTableL, supplierTableOut, "&& (== ([l_nationkey], int[1]), > ([l_name], string [Supplier#000009378]))", projections, THREAD_NUM);
		myOp.run ();
		auto end = chrono::high_resolution_clock::now();
		cout << "[RegularSelection Duration]: " << chrono::duration_cast<chrono::milliseconds>(end-begin).count()  << " milliseconds." << endl;
...
//			auto begin = chrono::high_resolution_clock::now();
			...
			myOp.run ();
//			auto end = chrono::high_resolution_clock::now();
//			cout << "[ScanJoin Duration]: " << chrono::duration_cast<chrono::nanoseconds>(end-begin).count()  << " nanoseconds." << endl;
		} else if (res == 1) {
...
//		auto begin = chrono::high_resolution_clock::now();
		...
		myOpAgain.run ();
//		auto end = chrono::high_resolution_clock::now();
//		cout << "[Aggregate Duration]: " << chrono::duration_cast<chrono::nanoseconds>(end-begin).count()  << " nanoseconds." << endl;
...
//		cin >> res;
		...
		if (res == 2) {
            ...
            ScanJoin myOp (supplierTableL, supplierTableRNoBPlus, supplierTableOut,
                           ...
                           "< ([l_nationkey], int[2])",
                           "bool[true]");
//			ScanJoinMultiThread myOp (supplierTableL, supplierTableRNoBPlus, supplierTableOut,
//						   "== ([l_nationkey], [r_nationkey]))", projections, hashAtts,
//						   "< ([l_nationkey], int[2])",
//						   "bool[true]", THREAD_NUM);
            cout << "running join (may take some time)\n";
            myOp.run ();
            auto end = chrono::high_resolution_clock::now();
            cout << "[ScanJoin Duration]: " << chrono::duration_cast<chrono::milliseconds>(end-begin).count()  << " milliseconds." << endl;
		} else if (res == 1) {
			SortMergeJoin myOp (supplierTableL, supplierTableRNoBPlus, supplierTableOut, 
				"== ([l_nationkey], [r_nationkey]))", projections, 
				make_pair (string ("[l_nationkey]"), string ("[r_nationkey]")),
        ...
        myOpAgain.run ();
        auto end = chrono::high_resolution_clock::now();
        cout << "[Aggregate Duration]: " << chrono::duration_cast<chrono::milliseconds>(end-begin).count()  << " milliseconds." << endl;
