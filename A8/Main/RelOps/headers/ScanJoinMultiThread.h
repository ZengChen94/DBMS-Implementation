...
#ifndef A7_SCANJOINMULTITHREAD_H
#define A7_SCANJOINMULTITHREAD_H
...
public:
    ...
    //         "== ([r_nationkey], int[3])");
    //
    ScanJoinMultiThread (MyDB_TableReaderWriterPtr leftInput, MyDB_TableReaderWriterPtr rightInput,
                         ...
                         string rightSelectionPredicate, int threadNum);
...
#endif //A7_SCANJOINMULTITHREAD_H
